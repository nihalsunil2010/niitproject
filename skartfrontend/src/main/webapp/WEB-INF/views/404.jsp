...
#fof .hgroup h1 span strong{display:inline-block; padding:16 20px 20px; border:1px solid #CCCCCC; font-weight:normal;}
  ...
  <div id="container" class="clear">
    ...
    <section id="fof" class="clear">
      ...
      <div class="hgroup">
        ...
        <h2>Error !</h2> <span>Page Not Found</span>
      </div>
      <p>For Some Reason The Page You Requested Could Not Be Found On Our Server</p>
      <p><a href="javascript:history.go(-1)">&laquo; Go Back</a> / <a href="${pageContext.request.contextPath}/home">Go Home &raquo;</a></p>
      <!-- ####################################################################################################### -->
    </section>
